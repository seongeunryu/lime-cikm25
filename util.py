...
def compute_scores(model, corpus, batch_size, mode, result_file, dataset):
    ...
    dataloader = DataLoader(DevTest_Dataset(corpus, mode), batch_size=batch_size, shuffle=False, num_workers=batch_size // 4, pin_memory=True)     # num_workers=batch_size // 16
