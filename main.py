...
if __name__ == '__main__':
    ...
    if config.mode == 'train':
        ...
        config.test_model_path = './best_model/adressa/LIME-MHSA-MHSA/#3/LIME-MHSA-MHSA'
        config.test_output_file = './test/res/adressa/LIME-MHSA-MHSA/best_model_adressa_LIME-MHSA-MHSA_#3_LIME-MHSA-MHSA/LIME-MHSA-MHSA.txt'
        config.run_index = 3
        test(config, data_corpus)
