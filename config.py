...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--user_encoder', type=str, default='MHSA', choices=['CROWN', 'MINER', 'SUE', 'LSTUR', 'MHSA', 'ATT', 'CATT', 'FIM', 'PUE', 'GRU', 'OMAP'], help='User encoder')
        parser.add_argument('--content_encoder', type=str, default=None, choices=['CROWN', 'CNE', 'CNN', 'MHSA', 'KCNN', 'HDC', 'NAML', 'PNE', 'DAE', 'Inception'], help='Base news content encoder used inside LIME')
        ...
        parser.add_argument('--freshness_embedding_dim', type=int, default=100, help='Embedding dimension of freshness and lifetime in LIME')
        ...
        parser.add_argument('--num_buckets', type=int, default=100, help='Num_buckets for Lifetime-aware Freshness Encoder')
        parser.add_argument('--use_candidate_ware_clicked_news_attention', type=bool, default=False, choices=[True, False], help='Use Candidate-aware Clicked News Attention in LIME')
        ...
        parser.add_argument('--sigmoid_scaling_alpha', type=float, default=1.0, help='Scaling factor alpha for sigmoid weighting function in LANCER/LIME')
        parser.add_argument('--penalty_scaling_beta', type=float, default=0.5, help='Penalty factor applied when remaining lifetime is negative in LIME')
        ...
        parser.add_argument('--alpha', type=float, default=0.3, help='Loss weight for category predictor in CROWN')
        ...
        if self.dataset in ['mind']:  
            ...
            # self.max_history_num = 5          # for LIME test
        ...
        if self.dataset in ['mind']:
            ...
            # self.max_title_length = 16          # for LIME test
            # self.max_abstract_length = 16       # for LIME test
            self.batch_size =64
        else: 
            self.dropout_rate = 0.2
            self.gcn_layer_num = 4
